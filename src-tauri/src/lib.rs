...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            crate::commands::workflow::resume_autopilot,
            crate::commands::workflow::enter_autopilot_discussion,
            crate::commands::workflow::resume_autopilot_after_discussion,
            crate::commands::workflow::exit_autopilot_keep_state,
